...
namespace rsm_backend.Infrastructure.Migrations
{
    ...
    [Migration("20260707091735_DiscountAmount_AdddedTo_ProductVariant")]
    partial class DiscountAmount_AdddedTo_ProductVariant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rsm_backend.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasIndex("DeliveryOptionId")
                        .HasDatabaseName("ix_cart_items_delivery_option_id");
            ...
            modelBuilder.Entity("rsm_backend.Domain.Entities.ProductTag", b =>
                {
                    b.Property<int>("ProductID")
                        .HasColumnType("integer")
                        .HasColumnName("product_id");
            ...
            modelBuilder.Entity("rsm_backend.Domain.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("rsm_backend.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("rsm_backend.Domain.Entities.DeliveryOption", "DeliveryOption")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_cart_items_delivery_options_delivery_option_id");
            ...
            modelBuilder.Entity("rsm_backend.Domain.Entities.ProductTag", b =>
                {
                    ...
                    b.HasOne("rsm_backend.Domain.Entities.Tag", "Tag")
                        .WithMany("ProductTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
