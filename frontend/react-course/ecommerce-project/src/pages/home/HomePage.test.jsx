...
describe('HomePage component', () => {
    ...
    it('adds to cart when the addToCart button is pressed', async()=>{
        render(
        ...
        const productContainers = await screen.findAllByTestId('product-container');
        const quantitySelector1= within(productContainers[0]).getByTestId('quantitySelector');
        ...
        const quantitySelector2= within(productContainers[1]).getByTestId('quantitySelector');
